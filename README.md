...
When hosting at `https://<user>.github.io/<repo>/`, Vite and React Router must both know the sub-path. This project defaults to `/tokens/` (the current repo). If your repository name changes, override it:
